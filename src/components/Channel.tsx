...
class Channel extends React.PureComponent<ChannelProps, { pendingMessage: string, messages: Message[]}> {
    ...
    submitMessage() {
        this.setState(prevState => { return {...prevState, messages: prevState.messages.concat([{
            ...
            createdDate: new Date(1622272285000),
            modifiedDate: new Date(1622272285000),
...
*/
                {
                  ...
                  createdDate: new Date(1622315285000),
                  modifiedDate: new Date(1622315285000),
                  messageId: "F0E4C2F76C58916EC258F246851BEA091D14D4247A2FC3E18694461B1816E13B",
                  content: {
                      "senderId": "@<00000000-0000-0000-0000-000000000000>",
                      "type": "post",
                      "text": ["Test message", "Test 2", "Test 3"]
                  }
                },
                {
                  channelId: "00000000-0000-0000-0000-000000000000",
                  ...
                  createdDate: new Date(1622315295000),
                  modifiedDate: new Date(1622315295000),
                  messageId: "A0E4C2F76C58916EC258F246851BEA091D14D4247A2FC3E18694461B1816E13A",
                  content: {
                ...
                },
                {
                  ...
                  createdDate: new Date(1622315296000),
                  modifiedDate: new Date(1622315296000),
                  messageId: "F0E4C2F76C58916EC258F246851BEA091D14D4247A2FC3E18694461B1816E13C",
                  content: {
                      "senderId": "@<00000000-0000-0000-0000-000000000000>",
                      "type": "post",
                      "text": "Test 5"
                ...
                },
                {
                  ...
                  createdDate: new Date(1622315396000),
                  modifiedDate: new Date(1622315396000),
                  messageId: "F0E4C2F76C58916EC258F246851BEA091D14D4247A2FC3E18694461B1816E13D",
                  content: {
                      "senderId": "@<00000000-0000-0000-0000-000000000000>",
                      "type": "post",
                      "text": "Test 6"
        ...
        return <div className="channel">
            ...
            <div className="message-list">
                {this.state.messages.map(message => {
                    ...
                    let time = moment.tz(message.createdDate, "America/Los_Angeles");
