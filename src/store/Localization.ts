...
export const unloadedState: LocalizationInfoState = { isLoading: false, langId: "", direction: "ltr", localizations: {} };

export const localizationReducer: Reducer<LocalizationInfoState> = (state: LocalizationInfoState | undefined, incomingAction: Action): LocalizationInfoState => {
