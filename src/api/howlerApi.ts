...
// -----------------
// APIs
export const getSpace = (spaceId: string) => wrapGetRequest<Space>(`/spaces/${spaceId}`);

export const getChannel = (spaceId: string, channelId: string) => wrapGetRequest<Channel>(`/spaces/${spaceId}/${channelId}`);
